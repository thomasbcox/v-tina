...
- close/4 — round 4: presented re-review or merge; Thomas chose **merge** (2026-09-10). (Rounds 1–3 each presented re-review only, as the approach gate required, and he took it each time.)
